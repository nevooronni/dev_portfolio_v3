    ...
    <main className="min-h-screen">
      ...
      <article className="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-32">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="animate-in fade-in slide-in-from-left-8 mx-auto w-full max-w-4xl duration-1000 break-words">
            <div className="mb-8">
              <Button
                asChild
                variant="ghost"
            ...
            <h1 className="font-heading mb-8 text-4xl leading-[1.1] font-black md:text-5xl lg:text-6xl break-words">
              {project.title}
            </h1>

            <p className="text-muted-foreground mb-10 text-xl leading-relaxed md:text-2xl break-words">
              {project.description}
            </p>
            ...
            {project.impact && (
              <div className="bg-accent/5 border-accent mb-12 rounded-2xl border-l-4 p-6 md:p-8 break-words">
            ...
            <div className="prose prose-lg dark:prose-invert prose-headings:font-heading prose-headings:font-bold prose-a:text-accent hover:prose-a:text-accent/80 w-full max-w-none break-words overflow-x-hidden">
